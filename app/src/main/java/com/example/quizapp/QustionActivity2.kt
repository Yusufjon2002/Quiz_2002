...
class QustionActivity2: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Name=intent.getStringExtra(setdata2.name)

        questionList=setdata2.getQuestion2()
            ...
            if (selecedOpinion!=0)
            {
                ...
                when{
                    currentPosition<=questionList!!.size->{
                        ...
                        intent.putExtra(setdata2.name,Name.toString())
